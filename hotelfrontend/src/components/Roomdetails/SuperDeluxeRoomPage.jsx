...
export const SuperDeluxeRoomPage = () => {
  ...
  const fetchRoomDetails = async () => {
    try {
      const response = await axios.get(`${FETCH_ROOMTYPENAME}/Super Deluxe`);
  ...
  useEffect(() => {
    const loadRoomData = async () => {
      try {
        ...
        console.log("this is room details",response)
  ...
  const roomTypeId =2;  // clearly named
    ...
    <div className="py-5" style={{ backgroundColor: "#f8f9fa" }}>
      ...
      <Container>
        <Row className="mb-4">
          ...
          <Col md={6}>
            <h2 className="mb-3">Super Deluxe Room</h2>
            <p>
          ...
          <h2 className="mb-3"> Super Deluxe Room Details</h2>
